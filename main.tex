...
\begin{titlepage}
    ...
    % Có thể thêm logo nếu có (ví dụ: \includegraphics[width=4cm]{logo.png}\\[1cm])
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{kien_truc_he_thong.png} % Thay thế bằng tên file ảnh của bạn
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{minh_hoa_ar_mon_an.png} % Thay thế bằng tên file ảnh của bạn
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{ui_user_dang_nhap_dang_ky.png} % Thay thế bằng tên file ảnh của bạn
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{ui_user_thuc_don.png} % Thay thế bằng tên file ảnh của bạn
    \caption{Giao diện thực đơn và chi tiết món ăn của người dùng}
    \label{fig:ui_user_menu}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{ui_user_gio_hang_thanh_toan.png} % Thay thế bằng tên file ảnh của bạn
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{ui_user_danh_gia_gop_y.png} % Thay thế bằng tên file ảnh của bạn
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{ui_user_cai_dat_tai_khoan.png} % Thay thế bằng tên file ảnh của bạn
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{ui_admin_quan_ly_thuc_don.png} % Thay thế bằng tên file ảnh của bạn
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{ui_admin_quan_ly_don_hang.png} % Thay thế bằng tên file ảnh của bạn
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{ui_admin_bao_cao_doanh_thu.png} % Thay thế bằng tên file ảnh của bạn
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{ui_admin_quan_ly_nguoi_dung.png} % Thay thế bằng tên file ảnh của bạn
